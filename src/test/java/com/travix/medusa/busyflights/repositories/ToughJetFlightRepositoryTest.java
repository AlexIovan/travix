...
@DataJpaTest
public class ToughJetFlightRepositoryTest {
    ...
    @Test
    public void testReadToughJetFlightsFound() {
        Collection<ToughJetFlight> toughJetFlights = toughJetFlightRepository.findFlights
    ...
    @Test
    public void testReadToughJetFlightsNotFound() {
        Collection<ToughJetFlight> toughJetFlights = toughJetFlightRepository.findFlights
